...
function Footer() {
  return (
    <main className='h-[15vh] bg-background flex items-center justify-around p-3 border-t'>
        ...
        <ul className='flex items-center justify-around text-center gap-16 '>
            <Link href="/contact" className='hover:text-blue transition duration-300'><li>Contacto</li></Link>
            ...
            <Link href="/faq" className='hover:text-blue transition duration-300'><li>Preguntas frecuentes</li></Link>
        </ul>
        <CgDarkMode size={22} className='invisible'/>
    </main>
  )
