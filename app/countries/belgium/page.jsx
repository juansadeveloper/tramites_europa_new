...
function Page() {
    ...
    prerequisites: (
      <div className="flex flex-col items-start gap-5 w-full md:px-20 mt-20">
        <div className="bg-white p-4 rounded shadow w-full">
          ...
          <p>Ensure your Italian passport or national ID card is valid for the duration of your stay in Belgium.</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
        ...
        <div className="bg-white p-4 rounded shadow w-full">
          ...
          <p>Opening a Belgian bank account is recommended for salary payments and everyday transactions. You will need a valid ID, proof of address, and sometimes proof of employment to open an account.</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
          <h2 className="font-bold">Language</h2>
          <p>Belgium has three official languages: Dutch, French, and German. Proficiency in the relevant language can be highly beneficial for daily life, integration, and job opportunities.</p>
        </div>
      </div>
    ),
    steps: (
      <div className="flex flex-col items-center gap-5 w-full md:px-20 mt-20">
        <div className="bg-white p-4 rounded shadow w-full">
          <h2 className="font-bold">Arrive in Belgium:</h2>
        ...
        <div className="bg-white p-4 rounded shadow w-full">
          ...
          <p>Within eight days of arrival, register with the local municipal administration (commune/gemeente).</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
          <h2 className="font-bold">Get Health Insurance:</h2>
          <p>If employed, you will be automatically enrolled in the Belgian social security system; otherwise, arrange for private health insurance or ensure you have the EHIC.</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
    ...
    recommendations: (
      <div className="flex flex-col items-center gap-5 w-full md:px-20 mt-20">
        <div className="bg-white p-4 rounded shadow w-full">
          ...
          <p>Understand the Belgian tax system and ensure you register with the local tax authorities.</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
        ...
        <div className="bg-white p-4 rounded shadow w-full">
          ...
          <p>Consider enrolling in language courses (Dutch, French, or German) to improve your language skills, which can aid in integration and job prospects.</p>
        </div>
      </div>
    )
  };
  ...
  return (
    <main className="min-h-[75vh] py-20 flex flex-col justify-center items-center">
      <h1 className="font-bold mb-10 text-xl">Belgium</h1>
