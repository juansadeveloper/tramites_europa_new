...
function Page() {
    ...
    prerequisites: (
      <div className="flex flex-col items-start gap-5 w-full md:px-20 mt-20">
        <div className="bg-white p-4 rounded shadow w-full">
          ...
          <p>Ensure your passport or national ID card is valid for the duration of your stay in Iceland.</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
          <h2 className="font-bold">Registration with Local Authorities</h2>
          <p>If you plan to stay in Iceland for more than three months, you must register your residence with the Registers Iceland (Þjóðskrá) and obtain a Kennitala (Icelandic ID number).</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
        ...
        <div className="bg-white p-4 rounded shadow w-full">
          ...
          <p>As an EU citizen, you do not need a work permit to work in Iceland. Employers may ask for proof of identity and your registration certificate.</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
          <h2 className="font-bold">Housing</h2>
          <p>Arrange accommodation before or soon after your arrival. The housing market can be competitive, particularly in larger cities like Reykjavik, so it&rsquo;s advisable to start looking early.</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
          <h2 className="font-bold">Bank Account</h2>
          <p>Opening an Icelandic bank account is recommended for salary payments and everyday transactions. You will need a valid ID, proof of address, and sometimes proof of employment to open an account.</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
          <h2 className="font-bold">Language</h2>
          <p>While many Icelanders speak English, proficiency in Icelandic is highly beneficial for daily life, integration, and job opportunities.</p>
        </div>
      </div>
    ),
    steps: (
      <div className="flex flex-col items-center gap-5 w-full md:px-20 mt-20">
        <div className="bg-white p-4 rounded shadow w-full">
          <h2 className="font-bold">Arrive in Iceland:</h2>
        ...
        <div className="bg-white p-4 rounded shadow w-full">
          <h2 className="font-bold">Obtain a Kennitala (Icelandic ID Number):</h2>
          <p>Apply for a Kennitala at Registers Iceland (Þjóðskrá).</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
          <h2 className="font-bold">Register with Local Authorities:</h2>
          <p>If you plan to stay for more than three months, register your residence with Registers Iceland.</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
          <h2 className="font-bold">Get Health Insurance:</h2>
          <p>If employed, you will be automatically enrolled in the Icelandic National Health Insurance system; otherwise, arrange for private health insurance or ensure you have the EHIC.</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
    ...
    recommendations: (
      <div className="flex flex-col items-center gap-5 w-full md:px-20 mt-20">
        <div className="bg-white p-4 rounded shadow w-full">
          ...
          <p>Understand the Icelandic tax system and ensure you register with the local tax authorities.</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
          <h2 className="font-bold">Social Security:</h2>
          <p>Familiarize yourself with the Icelandic social security system, including benefits and pension schemes.</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
          <h2 className="font-bold">Driver&rsquo;s License:</h2>
          <p>If you plan to drive, check the regulations for using or exchanging your EU driver&rsquo;s license. EU licenses are generally recognized in Iceland.</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
          <h2 className="font-bold">Language Courses:</h2>
          <p>Consider enrolling in Icelandic language courses to improve your language skills, which can aid in integration and job prospects.</p>
        </div>
      </div>
    )
  };
  ...
  return (
    <main className="min-h-[75vh] py-20 flex flex-col justify-center items-center">
      <h1 className="font-bold mb-10 text-xl">Iceland</h1>
