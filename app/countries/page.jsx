...
function Page() {
  return (
    <main className='min-h-[75vh] text-center flex flex-col justify-center items-center px-4'>
      <p className='mt-10 max-lg:hidden'>Click to select the country</p>
      <p className='mt-10 lg:hidden'>Select the country</p>
      <div className='grid gap-3 max-w-[940px] m-auto grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 justify-center my-[40px]'>
        <Link href="/countries/spain"><button className='font-light text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Spain</button></Link>
        <Link href="/countries/the-netherlands"><button className='font-light text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>The Netherlands</button></Link>
        <Link href="/countries/ireland"><button className='font-light text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Ireland</button></Link>
        <Link href="/countries/germany"><button className='font-light cursor-pointer text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Germany</button></Link>
        <Link href="/countries/portugal"><button className='font-light cursor-pointer text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Portugal</button></Link>
        <Link href="/countries/denmark"><button className='font-light cursor-pointer text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Denmark</button></Link>
        <Link href="/countries/austria"><button className='font-light cursor-pointer text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Austria</button></Link>
        <Link href="/countries/greece"><button className='font-light text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Greece</button></Link>
        <Link href="/countries/malta"><button className='font-light cursor-pointer text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Malta</button></Link>
        <Link href="/countries/belgium"><button className='font-light cursor-pointer text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Belgium</button></Link>
        <Link href="/countries/hungary"><button className='font-light text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Hungary</button></Link>
        <Link href="/countries/norway"><button className='font-light text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Norway</button></Link>
        <Link href="/countries/czech-republic"><button className='font-light text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Czech Republic</button></Link>
        <Link href="/countries/iceland"><button className='font-light text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Iceland</button></Link>
        <Link href="/countries/poland"><button className='font-light text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Poland</button></Link>
        <Link href="/countries/estonia"><button className='font-light text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Estonia</button></Link>
        <Link href="/countries/latvia"><button className='font-light text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Latvia</button></Link>
        <Link href="/countries/slovakia"><button className='font-light text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Slovakia</button></Link>
        <Link href="/countries/finland"><button className='font-light text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Finland</button></Link>
        <Link href="/countries/lithuania"><button className='font-light text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Lithuania</button></Link>
        <Link href="/countries/sweden"><button className='font-light text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Sweden</button></Link>
        <Link href="/countries/italy"><button className='font-light text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Italy</button></Link>
        <Link href="/countries/france"><button className='font-light cursor-pointer text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>France</button></Link>
        <Link href="/countries/luxembourg"><button className='font-light text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Luxembourg</button></Link>
        <Link href="/countries/switzerland"><button className='font-light cursor-pointer text-blue border border-blue hover:text-darkwhite hover:bg-blue blue w-full sm:min-w-[150px] py-3'>Switzerland</button></Link>
        <Link href="/countries/liechtenstein"><button className='font-light text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Liechtenstein</button></Link>
        <Link href="/countries/slovenia"><button className='font-light text-blue border border-blue hover:text-darkwhite hover:bg-blue w-full sm:min-w-[150px] py-3'>Slovenia</button></Link>
      </div>
      <Link href="/"><p className='hover:text-blue mt-4 mb-10'>Go back</p></Link>
      {/* <button className='relative left-0 shadow-lg px-4 py-1 rounded-md border bg-white'>Go back</button> */}
    </main>
  )
}
