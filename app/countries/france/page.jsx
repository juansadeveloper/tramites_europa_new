    ...
    prerequisites: (
      <div className="flex flex-col items-start gap-5 w-full md:px-20 mt-20">
        <div className="bg-white p-4 rounded shadow w-full">
          ...
          <p>Ensure your Italian passport or national ID card is valid for the duration of your stay in France.</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
          <h2 className="font-bold">Registration with Local Authorities</h2>
          <p>Although it is not mandatory for EU citizens to register with local authorities, it is recommended to register your residence with the local mairie (town hall) if you plan to stay for more than three months. This can help with administrative processes and accessing public services.</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
          <h2 className="font-bold">Health Insurance</h2>
          <p>You are required to have health insurance coverage in France. If you are employed, you will typically be covered by the French social security system (Sécurité Sociale). You can also apply for the European Health Insurance Card (EHIC) before moving, which provides temporary health coverage. Alternatively, you can get private health insurance if you are not employed or want additional coverage.</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
          <h2 className="font-bold">Employment</h2>
          <p>As an EU citizen, you do not need a work permit to work in France. Employers may ask for proof of identity and possibly proof of registration with the local mairie.</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
        ...
        <div className="bg-white p-4 rounded shadow w-full">
          ...
          <p>Opening a French bank account is recommended for salary payments and everyday transactions. You will need a valid ID, proof of address, and sometimes proof of employment to open an account.</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
          <h2 className="font-bold">Language</h2>
          <p>While many French people speak English, proficiency in French is highly beneficial for daily life, integration, and job opportunities.</p>
        </div>
      </div>
    ),
    steps: (
      <div className="flex flex-col items-center gap-5 w-full  md:px-20 mt-20">
        ...
        <div className="bg-white p-4 rounded shadow w-full">
          <h2 className="font-bold">Register with Local Authorities (optional):</h2>
          <p>If you plan to stay for more than three months, consider registering your residence with the local mairie.</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
          <h2 className="font-bold">Get Health Insurance:</h2>
          <p>If employed, you will be automatically enrolled in the French social security system; otherwise, arrange for private health insurance or ensure you have the EHIC.</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
    ...
    recommendations: (
      <div className="flex flex-col items-center gap-5 w-full  md:px-20 mt-20">
        ...
        <div className="bg-white p-4 rounded shadow w-full">
          ...
          <p>Consider enrolling in French language courses to improve your language skills, which can aid in integration and job prospects.</p>
        </div>
      </div>
    )
  };
