    ...
    prerequisites: (
      <div className="flex flex-col items-start gap-5 w-full md:px-20 mt-20">
        ...
        <div className="bg-white p-4 rounded shadow w-full">
          ...
          <p>Arrange accommodation before or soon after your arrival. The housing market can be competitive, particularly in larger cities like Vienna, so it’s advisable to start looking early.</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
    ...
    recommendations: (
      <div className="flex flex-col items-center gap-5 w-full md:px-20 mt-20">
        ...
        <div className="bg-white p-4 rounded shadow w-full">
          ...
          <p>If you plan to drive, check the regulations for using or exchanging your Italian driver’s license. EU licenses are generally recognized in Austria.</p>
        </div>
        <div className="bg-white p-4 rounded shadow w-full">
